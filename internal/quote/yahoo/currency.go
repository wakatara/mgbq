...
func transformResponseCurrency(responseQuote ResponseQuote) f.CurrencyRate {

	fromCurrency, toCurrency := getCurrencyPair(responseQuote.Symbol)

	return f.CurrencyRate{
...
func transformResponseCurrencies(responseQuotes []ResponseQuote) f.CurrencyRates {

	currencyRates := f.CurrencyRates{}
